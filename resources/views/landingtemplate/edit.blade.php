...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Landing Template') . ' ' . $landingtemplate->name }}
            </h2>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <form class="landing-template-form" action="{{ route('landingtemplates.update',['id' => $landingtemplate->id]) }}" method="POST">
            @csrf 
            <div class="shadow overflow-hidden sm:rounded-md">
              <div class="px-4 py-5 bg-white sm:p-6 landing-template-form-sec">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <input id="name" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" name="name" value ="{{ $landingtemplate->name }}"/>
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input id="content" type="hidden" class="mt-1 block w-full" name="content" value="{{ $landingtemplate->content }}"/>
                    
                    <input id="html" type="hidden" class="mt-1 block w-full" name="html" value="{{ $landingtemplate->html }}" />
                    <input id="css" type="hidden" class="mt-1 block w-full" name="css" value="{{ $landingtemplate->css }}" />
...
<style>
    ...
    <script type="text/javascript">
      ...
      var editor  = grapesjs.init({
        ...
        styel:this.LandingPage.style ||this.LandingPage.css,
        plugins: [
