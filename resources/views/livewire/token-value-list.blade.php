<div>
    ...
    <x-action-section>
        ...
        <x-slot name="content">
            <div class="container">
                <table class="table table-bordered" id="token_value_table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>TOKENS</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var table = $('#token_value_table').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            paging: true,
        ...
        $('#token_value_table').on('click', '.btn-delete[data-remote]', function (e){ 
