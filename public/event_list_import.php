...
if(isset($_POST["submit"])) {
	...
	$load_query = "INSERT IGNORE INTO eventemails (email,created_at,updated_at)
	    VALUES ";
	$load_query_eventlisting = "INSERT IGNORE INTO eventlisting_emails (event_listing_id,event_email_id,in_pool)
	    VALUES ";
	while(!$lines->eof()) {
