                ...
                if($allRule->status == 'running'){
                    ...
                    if($allEmailsInfos > 0){
                        ...
                        if($allRule->connection_type == 0){
                            ...
                            //new code added
                            // $temp_event_name = $spintax->process($temp_event_name);
                            // $event_content = $spintax->process($event_content);
                        ...
                        Mail::raw('Please Stop the rule '.$allRule->name.' all list sync sucessfully! ', function ($message) 
                            {
                              $message->to('mebongue@hotmail.com')
                                ->subject('Event Calander');
                            });
                    }
                }
            }
